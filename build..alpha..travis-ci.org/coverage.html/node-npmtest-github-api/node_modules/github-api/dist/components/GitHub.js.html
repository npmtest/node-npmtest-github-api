...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/GitHub.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/GitHub.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">60.87% <small>(28 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; GitHub.js</div>
</div>
<div class="body">
...
var GitHub = function () {
   ...
   */
<span class="fstat-no" title="function not covered" >  function GitHub(auth) {</span>
<span class="cstat-no" title="statement not covered" >    var apiBase = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : 'https://api.github.com';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, GitHub);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this.__apiBase = apiBase;</span>
<span class="cstat-no" title="statement not covered" >    this.__auth = auth || {};</span>
  }
&nbsp;
  /**
...
&nbsp;
  _createClass(GitHub, [{
    key: 'getGist',
    value: <span class="fstat-no" title="function not covered" >function getGist(id) {</span>
<span class="cstat-no" title="statement not covered" >      return new _Gist2.default(id, this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getUser',
    value: <span class="fstat-no" title="function not covered" >function getUser(user) {</span>
<span class="cstat-no" title="statement not covered" >      return new _User2.default(user, this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getOrganization',
    value: <span class="fstat-no" title="function not covered" >function getOrganization(organization) {</span>
<span class="cstat-no" title="statement not covered" >      return new _Organization2.default(organization, this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getTeam',
    value: <span class="fstat-no" title="function not covered" >function getTeam(teamId) {</span>
<span class="cstat-no" title="statement not covered" >      return new _Team2.default(teamId, this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getRepo',
    value: <span class="fstat-no" title="function not covered" >function getRepo(user, repo) {</span>
<span class="cstat-no" title="statement not covered" >      return new _Repository2.default(this._getFullName(user, repo), this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getIssues',
    value: <span class="fstat-no" title="function not covered" >function getIssues(user, repo) {</span>
<span class="cstat-no" title="statement not covered" >      return new _Issue2.default(this._getFullName(user, repo), this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'search',
    value: <span class="fstat-no" title="function not covered" >function search(query) {</span>
<span class="cstat-no" title="statement not covered" >      return new _Search2.default(query, this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getRateLimit',
    value: <span class="fstat-no" title="function not covered" >function getRateLimit() {</span>
<span class="cstat-no" title="statement not covered" >      return new _RateLimit2.default(this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getMarkdown',
    value: <span class="fstat-no" title="function not covered" >function getMarkdown() {</span>
<span class="cstat-no" title="statement not covered" >      return new _Markdown2.default(this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getProject',
    value: <span class="fstat-no" title="function not covered" >function getProject(id) {</span>
<span class="cstat-no" title="statement not covered" >      return new _Project2.default(id, this.__auth, this.__apiBase);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: '_getFullName',
    value: <span class="fstat-no" title="function not covered" >function _getFullName(user, repo) {</span>
<span class="cstat-no" title="statement not covered" >      var fullname = user;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (repo) {</span>
<span class="cstat-no" title="statement not covered" >        fullname = user + '/' + repo;</span>
      }
&nbsp;
