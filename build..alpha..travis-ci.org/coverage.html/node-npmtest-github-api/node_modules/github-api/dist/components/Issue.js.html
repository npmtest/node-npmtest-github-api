...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/Issue.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/Issue.js</span></h1>
    <h2>
        
        Statements: <span class="metric">50% <small>(31 / 62)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; Issue.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function Issue(repository, auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Issue);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Issue.__proto__ || Object.getPrototypeOf(Issue)).call(this, auth, apiBase));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.__repository = repository;</span>
...
&nbsp;
  _createClass(Issue, [{
    key: 'createIssue',
    value: <span class="fstat-no" title="function not covered" >function createIssue(issueData, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('POST', '/repos/' + this.__repository + '/issues', issueData, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'listIssues',
    value: <span class="fstat-no" title="function not covered" >function listIssues(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._requestAllPages('/repos/' + this.__repository + '/issues', options, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'listIssueEvents',
    value: <span class="fstat-no" title="function not covered" >function listIssueEvents(issue, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/issues/' + issue + '/events', null, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function listIssueComments(issue, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/issues/' + issue + '/comments', null, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getIssueComment',
    value: <span class="fstat-no" title="function not covered" >function getIssueComment(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/issues/comments/' + id, null, cb);</span>
    }
&nbsp;
    /**
     * Comment on an issue
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function createIssueComment(issue, comment, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('POST', '/repos/' + this.__repository + '/issues/' + issue + '/comments', { body: comment }, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function editIssueComment(id, comment, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PATCH', '/repos/' + this.__repository + '/issues/comments/' + id, { body: comment }, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    value: <span class="fstat-no" title="function not covered" >function deleteIssueComment(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('DELETE', '/repos/' + this.__repository + '/issues/comments/' + id, null, cb);</span>
    }
&nbsp;
    /**
     * Edit an issue
...
&nbsp;
    ...
    key: 'editIssue',
    value: <span class="fstat-no" title="function not covered" >function editIssue(issue, issueData, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PATCH', '/repos/' + this.__repository + '/issues/' + issue, issueData, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getIssue',
    value: <span class="fstat-no" title="function not covered" >function getIssue(issue, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/issues/' + issue, null, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'listMilestones',
    value: <span class="fstat-no" title="function not covered" >function listMilestones(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/milestones', options, cb);</span>
    }
&nbsp;
    /**
     * Get a milestone
...
&nbsp;
    ...
    key: 'getMilestone',
    value: <span class="fstat-no" title="function not covered" >function getMilestone(milestone, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/milestones/' + milestone, null, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'createMilestone',
    value: <span class="fstat-no" title="function not covered" >function createMilestone(milestoneData, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('POST', '/repos/' + this.__repository + '/milestones', milestoneData, cb);</span>
    }
&nbsp;
    /**
     * Edit a milestone
...
&nbsp;
    ...
    key: 'editMilestone',
    value: <span class="fstat-no" title="function not covered" >function editMilestone(milestone, milestoneData, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PATCH', '/repos/' + this.__repository + '/milestones/' + milestone, milestoneData, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'deleteMilestone',
    value: <span class="fstat-no" title="function not covered" >function deleteMilestone(milestone, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('DELETE', '/repos/' + this.__repository + '/milestones/' + milestone, null, cb);</span>
    }
&nbsp;
    /**
     * Create a new label
...
&nbsp;
    ...
    key: 'createLabel',
    value: <span class="fstat-no" title="function not covered" >function createLabel(labelData, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('POST', '/repos/' + this.__repository + '/labels', labelData, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'listLabels',
    value: <span class="fstat-no" title="function not covered" >function listLabels(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/labels', options, cb);</span>
    }
&nbsp;
    /**
     * Get a label
...
&nbsp;
    ...
    key: 'getLabel',
    value: <span class="fstat-no" title="function not covered" >function getLabel(label, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/repos/' + this.__repository + '/labels/' + label, null, cb);</span>
    }
&nbsp;
    /**
     * Edit a label
...
&nbsp;
    ...
    key: 'editLabel',
    value: <span class="fstat-no" title="function not covered" >function editLabel(label, labelData, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PATCH', '/repos/' + this.__repository + '/labels/' + label, labelData, cb);</span>
    }
&nbsp;
    /**
     * Delete a label
...
&nbsp;
    ...
    key: 'deleteLabel',
    value: <span class="fstat-no" title="function not covered" >function deleteLabel(label, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('DELETE', '/repos/' + this.__repository + '/labels/' + label, null, cb);</span>
    }
  }]);
&nbsp;
  return Issue;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 20 2017 14:15:35 GMT+0000 (UTC)</div>
</div>
</body>
</html>
