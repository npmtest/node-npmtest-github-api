...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/Gist.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/Gist.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; Gist.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function Gist(id, auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Gist);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Gist.__proto__ || Object.getPrototypeOf(Gist)).call(this, auth, apiBase));</span>
&nbsp;
...
&nbsp;
  _createClass(Gist, [{
    key: 'read',
    value: <span class="fstat-no" title="function not covered" >function read(cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/gists/' + this.__id, null, cb);</span>
    }
&nbsp;
    /**
     * Create a new gist.
...
&nbsp;
    ...
    key: 'create',
    value: <span class="fstat-no" title="function not covered" >function create(gist, cb) {</span>
<span class="cstat-no" title="statement not covered" >      var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return this._request('POST', '/gists', gist, cb).then(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >        _this2.__id = response.data.id;</span>
...
&nbsp;
    ...
    key: 'delete',
    value: <span class="fstat-no" title="function not covered" >function _delete(cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('DELETE', '/gists/' + this.__id, null, cb);</span>
    }
&nbsp;
    /**
     * Fork a gist.
...
<span class="cstat-no" title="statement not covered" >      return this._request('POST', '/gists/' + this.__id + '/forks', null, cb);</span>
    }
&nbsp;
    /**
     * Update a gist.
...
&nbsp;
    ...
    key: 'update',
    value: <span class="fstat-no" title="function not covered" >function update(gist, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PATCH', '/gists/' + this.__id, gist, cb);</span>
    }
&nbsp;
    /**
     * Star a gist.
...
<span class="cstat-no" title="statement not covered" >      return this._request('PUT', '/gists/' + this.__id + '/star', null, cb);</span>
    }
&nbsp;
    /**
     * Unstar a gist.
...
<span class="cstat-no" title="statement not covered" >      return this._request('DELETE', '/gists/' + this.__id + '/star', null, cb);</span>
    }
&nbsp;
    /**
...
<span class="cstat-no" title="statement not covered" >      return this._request204or404('/gists/' + this.__id + '/star', null, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'listComments',
    value: <span class="fstat-no" title="function not covered" >function listComments(cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._requestAllPages('/gists/' + this.__id + '/comments', null, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getComment',
    value: <span class="fstat-no" title="function not covered" >function getComment(comment, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/gists/' + this.__id + '/comments/' + comment, null, cb);</span>
    }
&nbsp;
    /**
     * Comment on a gist
...
&nbsp;
    ...
    key: 'createComment',
    value: <span class="fstat-no" title="function not covered" >function createComment(comment, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('POST', '/gists/' + this.__id + '/comments', { body: comment }, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'editComment',
    value: <span class="fstat-no" title="function not covered" >function editComment(comment, body, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PATCH', '/gists/' + this.__id + '/comments/' + comment, { body: body }, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'deleteComment',
    value: <span class="fstat-no" title="function not covered" >function deleteComment(comment, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('DELETE', '/gists/' + this.__id + '/comments/' + comment, null, cb);</span>
    }
  }]);
&nbsp;
  return Gist;
