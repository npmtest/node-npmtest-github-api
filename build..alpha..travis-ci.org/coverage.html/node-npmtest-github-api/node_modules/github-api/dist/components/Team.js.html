...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/Team.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/Team.js</span></h1>
    <h2>
        
        Statements: <span class="metric">52.31% <small>(34 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; Team.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function Team(teamId, auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Team);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Team.__proto__ || Object.getPrototypeOf(Team)).call(this, auth, apiBase));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.__teamId = teamId;</span>
...
&nbsp;
  _createClass(Team, [{
    key: 'getTeam',
    value: <span class="fstat-no" title="function not covered" >function getTeam(cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Fetching Team ' + this.__teamId);</span>
<span class="cstat-no" title="statement not covered" >      return this._request('Get', '/teams/' + this.__teamId, undefined, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'listRepos',
    value: <span class="fstat-no" title="function not covered" >function listRepos(cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Fetching repositories for Team ' + this.__teamId);</span>
<span class="cstat-no" title="statement not covered" >      return this._requestAllPages('/teams/' + this.__teamId + '/repos', undefined, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'editTeam',
    value: <span class="fstat-no" title="function not covered" >function editTeam(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Editing Team ' + this.__teamId);</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PATCH', '/teams/' + this.__teamId, options, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'listMembers',
    value: <span class="fstat-no" title="function not covered" >function listMembers(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Getting members of Team ' + this.__teamId);</span>
<span class="cstat-no" title="statement not covered" >      return this._requestAllPages('/teams/' + this.__teamId + '/members', options, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'getMembership',
    value: <span class="fstat-no" title="function not covered" >function getMembership(username, cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Getting membership of user ' + username + ' in Team ' + this.__teamId);</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/teams/' + this.__teamId + '/memberships/' + username, undefined, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'addMembership',
    value: <span class="fstat-no" title="function not covered" >function addMembership(username, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Adding user ' + username + ' to Team ' + this.__teamId);</span>
<span class="cstat-no" title="statement not covered" >      return this._request('PUT', '/teams/' + this.__teamId + '/memberships/' + username, options, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'isManagedRepo',
    value: <span class="fstat-no" title="function not covered" >function isManagedRepo(owner, repo, cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Getting repo management by Team ' + this.__teamId + ' for repo ' + owner + '/' + repo);</span>
<span class="cstat-no" title="statement not covered" >      return this._request204or404('/teams/' + this.__teamId + '/repos/' + owner + '/' + repo, undefined, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'manageRepo',
    value: <span class="fstat-no" title="function not covered" >function manageRepo(owner, repo, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Adding or Updating repo management by Team ' + this.__teamId + ' for repo ' + owner + '/' + repo);</span>
<span class="cstat-no" title="statement not covered" >      return this._request204or404('/teams/' + this.__teamId + '/repos/' + owner + '/' + repo, options, cb, 'PUT');</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'unmanageRepo',
    value: <span class="fstat-no" title="function not covered" >function unmanageRepo(owner, repo, cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Remove repo management by Team ' + this.__teamId + ' for repo ' + owner + '/' + repo);</span>
<span class="cstat-no" title="statement not covered" >      return this._request204or404('/teams/' + this.__teamId + '/repos/' + owner + '/' + repo, undefined, cb, 'DELETE');</span>
    }
&nbsp;
    /**
     * Delete Team
...
&nbsp;
    ...
    key: 'deleteTeam',
    value: <span class="fstat-no" title="function not covered" >function deleteTeam(cb) {</span>
<span class="cstat-no" title="statement not covered" >      log('Deleting Team ' + this.__teamId);</span>
<span class="cstat-no" title="statement not covered" >      return this._request204or404('/teams/' + this.__teamId, undefined, cb, 'DELETE');</span>
    }
  }]);
&nbsp;
  return Team;
