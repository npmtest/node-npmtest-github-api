...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/User.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/User.js</span></h1>
    <h2>
        
        Statements: <span class="metric">46.58% <small>(34 / 73)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; User.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    */
<span class="fstat-no" title="function not covered" >   function User(username, auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, User);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _this = _possibleConstructorReturn(this, (User.__proto__ || Object.getPrototypeOf(User)).call(this, auth, apiBase));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _this.__user = username;</span>
...
&nbsp;
   _createClass(User, [{
      key: '__getScopedUrl',
      value: <span class="fstat-no" title="function not covered" >function __getScopedUrl(endpoint) {</span>
<span class="cstat-no" title="statement not covered" >         if (this.__user) {</span>
<span class="cstat-no" title="statement not covered" >            return endpoint ? '/users/' + this.__user + '/' + endpoint : '/users/' + this.__user;</span>
         } else {
            // eslint-disable-line
<span class="cstat-no" title="statement not covered" >            switch (endpoint) {</span>
               case '':
...
&nbsp;
               default:
<span class="cstat-no" title="statement not covered" >                  return '/user/' + endpoint;</span>
            }
         }
      }
&nbsp;
...
&nbsp;
      ...
      key: 'listRepos',
      value: <span class="fstat-no" title="function not covered" >function listRepos(options, cb) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         options = this._getOptionsWithDefaults(options);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         log('Fetching repositories with options: ' + JSON.stringify(options));</span>
<span class="cstat-no" title="statement not covered" >         return this._requestAllPages(this.__getScopedUrl('repos'), options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listOrgs',
      value: <span class="fstat-no" title="function not covered" >function listOrgs(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', this.__getScopedUrl('orgs'), null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listGists',
      value: <span class="fstat-no" title="function not covered" >function listGists(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', this.__getScopedUrl('gists'), null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function listNotifications(options, cb) {</span>
...
<span class="cstat-no" title="statement not covered" >         options.before = this._dateToISO(options.before);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this._request('GET', this.__getScopedUrl('notifications'), options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getProfile',
      value: <span class="fstat-no" title="function not covered" >function getProfile(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', this.__getScopedUrl(''), null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function listStarredRepos(cb) {</span>
<span class="cstat-no" title="statement not covered" >         var requestOptions = this._getOptionsWithDefaults();</span>
<span class="cstat-no" title="statement not covered" >         return this._requestAllPages(this.__getScopedUrl('starred'), requestOptions, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getEmails',
      value: <span class="fstat-no" title="function not covered" >function getEmails(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/user/emails', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'follow',
      value: <span class="fstat-no" title="function not covered" >function follow(username, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PUT', '/user/following/' + this.__user, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'unfollow',
      value: <span class="fstat-no" title="function not covered" >function unfollow(username, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/user/following/' + this.__user, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'createRepo',
      value: <span class="fstat-no" title="function not covered" >function createRepo(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/user/repos', options, cb);</span>
      }
   }]);
&nbsp;
   return User;
