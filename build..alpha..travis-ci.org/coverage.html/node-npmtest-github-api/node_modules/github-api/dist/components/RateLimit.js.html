...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/RateLimit.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/RateLimit.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; RateLimit.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function RateLimit(auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, RateLimit);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (RateLimit.__proto__ || Object.getPrototypeOf(RateLimit)).call(this, auth, apiBase));</span>
  }
&nbsp;
  /**
...
&nbsp;
  _createClass(RateLimit, [{
    key: 'getRateLimit',
    value: <span class="fstat-no" title="function not covered" >function getRateLimit(cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._request('GET', '/rate_limit', null, cb);</span>
    }
  }]);
&nbsp;
  return RateLimit;
