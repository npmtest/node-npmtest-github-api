...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/Project.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/Project.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; Project.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    */
<span class="fstat-no" title="function not covered" >   function Project(id, auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, Project);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _this = _possibleConstructorReturn(this, (Project.__proto__ || Object.getPrototypeOf(Project)).call(this, auth, apiBase, 'inertia-preview'));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _this.__id = id;</span>
...
&nbsp;
   _createClass(Project, [{
      key: 'getProject',
      value: <span class="fstat-no" title="function not covered" >function getProject(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/projects/' + this.__id, null, cb);</span>
      }
&nbsp;
      /**
       * Edit a project
...
&nbsp;
      ...
      key: 'updateProject',
      value: <span class="fstat-no" title="function not covered" >function updateProject(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/projects/' + this.__id, options, cb);</span>
      }
&nbsp;
      /**
       * Delete a project
...
&nbsp;
      ...
      key: 'deleteProject',
      value: <span class="fstat-no" title="function not covered" >function deleteProject(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/projects/' + this.__id, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function listProjectColumns(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._requestAllPages('/projects/' + this.__id + '/columns', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function getProjectColumn(colId, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/projects/columns/' + colId, null, cb);</span>
      }
&nbsp;
      /**
       * Create a new column
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function createProjectColumn(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/projects/' + this.__id + '/columns', options, cb);</span>
      }
&nbsp;
      /**
       * Edit a column
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function updateProjectColumn(colId, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/projects/columns/' + colId, options, cb);</span>
      }
&nbsp;
      /**
       * Delete a column
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function deleteProjectColumn(colId, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/projects/columns/' + colId, null, cb);</span>
      }
&nbsp;
      /**
       * Move a column
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function moveProjectColumn(colId, position, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/projects/columns/' + colId + '/moves', { position: position }, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function listProjectCards(cb) {</span>
<span class="cstat-no" title="statement not covered" >         var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this.listProjectColumns().then(<span class="fstat-no" title="function not covered" >function (_ref) {</span></span>
<span class="cstat-no" title="statement not covered" >            var data = _ref.data;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            return Promise.all(data.map(<span class="fstat-no" title="function not covered" >function (column) {</span></span>
<span class="cstat-no" title="statement not covered" >               return _this2._requestAllPages('/projects/columns/' + column.id + '/cards', null);</span>
            }));
         }).then(<span class="fstat-no" title="function not covered" >function (cardsInColumns) {</span>
<span class="cstat-no" title="statement not covered" >            var cards = cardsInColumns.reduce(<span class="fstat-no" title="function not covered" >function (prev, _ref2) {</span></span>
<span class="cstat-no" title="statement not covered" >               var data = _ref2.data;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >               prev.push.apply(prev, _toConsumableArray(data));</span>
...
<span class="cstat-no" title="statement not covered" >               cb(null, cards);</span>
            }
<span class="cstat-no" title="statement not covered" >            return cards;</span>
...
&nbsp;
      ...
      key: 'listColumnCards',
      value: <span class="fstat-no" title="function not covered" >function listColumnCards(colId, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._requestAllPages('/projects/columns/' + colId + '/cards', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getProjectCard',
      value: <span class="fstat-no" title="function not covered" >function getProjectCard(cardId, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/projects/columns/cards/' + cardId, null, cb);</span>
      }
&nbsp;
      /**
      * Create a new card
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function createProjectCard(colId, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/projects/columns/' + colId + '/cards', options, cb);</span>
      }
&nbsp;
      /**
      * Edit a card
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function updateProjectCard(cardId, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/projects/columns/cards/' + cardId, options, cb);</span>
      }
&nbsp;
      /**
      * Delete a card
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function deleteProjectCard(cardId, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/projects/columns/cards/' + cardId, null, cb);</span>
      }
&nbsp;
      /**
      * Move a card
...
&nbsp;
      ...
      key: 'moveProjectCard',
      value: <span class="fstat-no" title="function not covered" >function moveProjectCard(cardId, position, colId, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/projects/columns/cards/' + cardId + '/moves', { position: position, column_id: colId }, // eslint-disable-line camelcase</span>
         cb);
      }
   }]);
&nbsp;
