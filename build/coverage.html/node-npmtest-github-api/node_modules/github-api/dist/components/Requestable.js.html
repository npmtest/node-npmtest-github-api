...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/Requestable.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/Requestable.js</span></h1>
    <h2>
        
        Statements: <span class="metric">26.35% <small>(44 / 167)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">11.97% <small>(17 / 142)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; Requestable.js</div>
</div>
<div class="body">
...
388
389
390</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    ...
    */
<span class="fstat-no" title="function not covered" >   function ResponseError(message, path, response) {</span>
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, ResponseError);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _this = _possibleConstructorReturn(this, (ResponseError.__proto__ || Object.getPrototypeOf(ResponseError)).call(this, message));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _this.path = path;</span>
<span class="cstat-no" title="statement not covered" >      _this.request = response.config;</span>
<span class="cstat-no" title="statement not covered" >      _this.response = (response || {}).response || response;</span>
<span class="cstat-no" title="statement not covered" >      _this.status = response.status;</span>
...
var Requestable = function () {
    ...
    */
<span class="fstat-no" title="function not covered" >   function Requestable(auth, apiBase, AcceptHeader) {</span>
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, Requestable);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.__apiBase = apiBase || 'https://api.github.com';</span>
<span class="cstat-no" title="statement not covered" >      this.__auth = {</span>
         token: auth.token,
         username: auth.username,
         password: auth.password
      };
<span class="cstat-no" title="statement not covered" >      this.__AcceptHeader = AcceptHeader || 'v3';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (auth.token) {</span>
<span class="cstat-no" title="statement not covered" >         this.__authorizationHeader = 'token ' + auth.token;</span>
      } else <span class="cstat-no" title="statement not covered" >if (auth.username &amp;&amp; auth.password) {</span>
<span class="cstat-no" title="statement not covered" >         this.__authorizationHeader = 'Basic ' + _jsBase.Base64.encode(auth.username + ':' + auth.password);</span>
      }
   }
&nbsp;
   /**
...
&nbsp;
   _createClass(Requestable, [{
      key: '__getURL',
      value: <span class="fstat-no" title="function not covered" >function __getURL(path) {</span>
<span class="cstat-no" title="statement not covered" >         var url = path;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         if (path.indexOf('//') === -1) {</span>
<span class="cstat-no" title="statement not covered" >            url = this.__apiBase + path;</span>
         }
&nbsp;
<span class="cstat-no" title="statement not covered" >         var newCacheBuster = 'timestamp=' + new Date().getTime();</span>
<span class="cstat-no" title="statement not covered" >         return url.replace(/(timestamp=\d+)/, newCacheBuster);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function __getRequestHeaders(raw, AcceptHeader) {</span>
...
<span class="cstat-no" title="statement not covered" >            headers.Accept += '.raw';</span>
         }
<span class="cstat-no" title="statement not covered" >         headers.Accept += '+json';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         if (this.__authorizationHeader) {</span>
<span class="cstat-no" title="statement not covered" >            headers.Authorization = this.__authorizationHeader;</span>
         }
&nbsp;
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function _getOptionsWithDefaults() {</span>
<span class="cstat-no" title="statement not covered" >         var requestOptions = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         if (!(requestOptions.visibility || requestOptions.affiliation)) {</span>
<span class="cstat-no" title="statement not covered" >            requestOptions.type = requestOptions.type || 'all';</span>
         }
<span class="cstat-no" title="statement not covered" >         requestOptions.sort = requestOptions.sort || 'updated';</span>
<span class="cstat-no" title="statement not covered" >         requestOptions.per_page = requestOptions.per_page || '100'; </span>// eslint-disable-line
&nbsp;
...
&nbsp;
      ...
      key: '_dateToISO',
      value: <span class="fstat-no" title="function not covered" >function _dateToISO(date) {</span>
<span class="cstat-no" title="statement not covered" >         if (date &amp;&amp; date instanceof Date) {</span>
<span class="cstat-no" title="statement not covered" >            date = date.toISOString();</span>
         }
&nbsp;
...
&nbsp;
      ...
      key: '_request',
      value: <span class="fstat-no" title="function not covered" >function _request(method, path, data, cb, raw) {</span>
<span class="cstat-no" title="statement not covered" >         var url = this.__getURL(path);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         var AcceptHeader = (data || {}).AcceptHeader;</span>
<span class="cstat-no" title="statement not covered" >         if (AcceptHeader) {</span>
<span class="cstat-no" title="statement not covered" >            delete data.AcceptHeader;</span>
         }
<span class="cstat-no" title="statement not covered" >         var headers = this.__getRequestHeaders(raw, AcceptHeader);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         var queryParams = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         var shouldUseDataAsParams = data &amp;&amp; (typeof data === 'undefined' ? 'undefined' : _typeof(data)) === 'object' &amp;&amp; methodHasNoBody(method);</span>
<span class="cstat-no" title="statement not covered" >         if (shouldUseDataAsParams) {</span>
<span class="cstat-no" title="statement not covered" >            queryParams = data;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         log(config.method + ' to ' + config.url);</span>
<span class="cstat-no" title="statement not covered" >         var requestPromise = (0, _axios2.default)(config).catch(callbackErrorOrThrow(cb, path));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         if (cb) {</span>
<span class="cstat-no" title="statement not covered" >            requestPromise.then(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >               if (response.data &amp;&amp; Object.keys(response.data).length &gt; 0) {</span>
                  // When data has results
<span class="cstat-no" title="statement not covered" >                  cb(null, response.data, response);</span>
               } else <span class="cstat-no" title="statement not covered" >if (config.method !== 'GET' &amp;&amp; Object.keys(response.data).length &lt; 1) {</span>
                  // True when successful submit a request and receive a empty object
<span class="cstat-no" title="statement not covered" >                  cb(null, response.status &lt; 300, response);</span>
               } else {
<span class="cstat-no" title="statement not covered" >                  cb(null, response.data, response);</span>
               }
            });
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         return requestPromise;</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function _request204or404(path, data, cb) {</span>
<span class="cstat-no" title="statement not covered" >         var method = arguments.length &gt; 3 &amp;&amp; arguments[3] !== undefined ? arguments[3] : 'GET';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this._request(method, path, data).then(<span class="fstat-no" title="function not covered" >function success(response) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (cb) {</span>
<span class="cstat-no" title="statement not covered" >               cb(null, true, response);</span>
            }
<span class="cstat-no" title="statement not covered" >            return true;</span>
         }, <span class="fstat-no" title="function not covered" >function failure(response) {</span>
<span class="cstat-no" title="statement not covered" >            if (response.response.status === 404) {</span>
<span class="cstat-no" title="statement not covered" >               if (cb) {</span>
<span class="cstat-no" title="statement not covered" >                  cb(null, false, response);</span>
               }
...
<span class="cstat-no" title="statement not covered" >            throw response;</span>
         });
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function _requestAllPages(path, options, cb, results) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this._request('GET', path, options).then(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >            var _results;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var thisGroup = void 0;</span>
<span class="cstat-no" title="statement not covered" >            if (response.data instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >               thisGroup = response.data;</span>
            } else <span class="cstat-no" title="statement not covered" >if (response.data.items instanceof Array) {</span>
<span class="cstat-no" title="statement not covered" >               thisGroup = response.data.items;</span>
            } else {
<span class="cstat-no" title="statement not covered" >               var message = 'cannot figure out how to append ' + response.data + ' to the result set';</span>
<span class="cstat-no" title="statement not covered" >               throw new ResponseError(message, path, response);</span>
            }
<span class="cstat-no" title="statement not covered" >            (_results = results).push.apply(_results, _toConsumableArray(thisGroup));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var nextUrl = getNextPage(response.headers.link);</span>
<span class="cstat-no" title="statement not covered" >            if (nextUrl) {</span>
<span class="cstat-no" title="statement not covered" >               log('getting next page: ' + nextUrl);</span>
<span class="cstat-no" title="statement not covered" >               return _this2._requestAllPages(nextUrl, options, cb, results);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (cb) {</span>
<span class="cstat-no" title="statement not covered" >               cb(null, results, response);</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            response.data = results;</span>
...
<span class="fstat-no" title="function not covered" >function methodHasNoBody(method) {</span>
<span class="cstat-no" title="statement not covered" >   return METHODS_WITH_NO_BODY.indexOf(method) !== -1;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function getNextPage() {</span>
<span class="cstat-no" title="statement not covered" >   var linksHeader = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >   var links = linksHeader.split(/\s*,\s*/); </span>// splits and strips the urls
<span class="cstat-no" title="statement not covered" >   return links.reduce(<span class="fstat-no" title="function not covered" >function (nextUrl, link) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (link.search(/rel="next"/) !== -1) {</span>
<span class="cstat-no" title="statement not covered" >         return (link.match(/&lt;(.*)&gt;/) || [])[1];</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return nextUrl;</span>
   }, undefined);
}
&nbsp;
<span class="fstat-no" title="function not covered" >function callbackErrorOrThrow(cb, path) {</span>
<span class="cstat-no" title="statement not covered" >   return <span class="fstat-no" title="function not covered" >function handler(object) {</span></span>
<span class="cstat-no" title="statement not covered" >      var error = void 0;</span>
<span class="cstat-no" title="statement not covered" >      if (object.hasOwnProperty('config')) {</span>
<span class="cstat-no" title="statement not covered" >         var _object$response = object.response,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         var message = status + ' error making request ' + method + ' ' + url + ': "' + statusText + '"';</span>
<span class="cstat-no" title="statement not covered" >         error = new ResponseError(message, path, object);</span>
<span class="cstat-no" title="statement not covered" >         log(message + ' ' + JSON.stringify(object.data));</span>
      } else {
<span class="cstat-no" title="statement not covered" >         error = object;</span>
      }
<span class="cstat-no" title="statement not covered" >      if (cb) {</span>
<span class="cstat-no" title="statement not covered" >         log('going to error callback');</span>
<span class="cstat-no" title="statement not covered" >         cb(error);</span>
      } else {
<span class="cstat-no" title="statement not covered" >         log('throwing error');</span>
