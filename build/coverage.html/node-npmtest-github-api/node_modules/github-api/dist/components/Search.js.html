...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/Search.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/Search.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; Search.js</div>
</div>
<div class="body">
...
&nbsp;
   ...
   */
<span class="fstat-no" title="function not covered" >  function Search(defaults, auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Search);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (Search.__proto__ || Object.getPrototypeOf(Search)).call(this, auth, apiBase));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.__defaults = _this._getOptionsWithDefaults(defaults);</span>
...
&nbsp;
  _createClass(Search, [{
    key: '_search',
    value: <span class="fstat-no" title="function not covered" >function _search(path) {</span>
<span class="cstat-no" title="statement not covered" >      var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var withOptions = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : {};</span>
<span class="cstat-no" title="statement not covered" >      var cb = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : undefined;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var requestOptions = {};</span>
<span class="cstat-no" title="statement not covered" >      Object.keys(this.__defaults).forEach(<span class="fstat-no" title="function not covered" >function (prop) {</span></span>
<span class="cstat-no" title="statement not covered" >        requestOptions[prop] = _this2.__defaults[prop];</span>
      });
<span class="cstat-no" title="statement not covered" >      Object.keys(withOptions).forEach(<span class="fstat-no" title="function not covered" >function (prop) {</span></span>
<span class="cstat-no" title="statement not covered" >        requestOptions[prop] = withOptions[prop];</span>
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      log('searching ' + path + ' with options:', requestOptions);</span>
<span class="cstat-no" title="statement not covered" >      return this._requestAllPages('/search/' + path, requestOptions, cb);</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    key: 'forRepositories',
    value: <span class="fstat-no" title="function not covered" >function forRepositories(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._search('repositories', options, cb);</span>
    }
&nbsp;
    /**
     * Search for code
...
&nbsp;
    ...
    key: 'forCode',
    value: <span class="fstat-no" title="function not covered" >function forCode(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._search('code', options, cb);</span>
    }
&nbsp;
    /**
     * Search for issues
...
&nbsp;
    ...
    key: 'forIssues',
    value: <span class="fstat-no" title="function not covered" >function forIssues(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._search('issues', options, cb);</span>
    }
&nbsp;
    /**
     * Search for users
...
&nbsp;
    ...
    key: 'forUsers',
    value: <span class="fstat-no" title="function not covered" >function forUsers(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >      return this._search('users', options, cb);</span>
    }
  }]);
&nbsp;
  return Search;
