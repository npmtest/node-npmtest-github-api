...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-github-api/node_modules/github-api/dist/components/Repository.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-github-api">npmtest-github-api (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-github-api/node_modules/github-api/dist/components/Repository.js</span></h1>
    <h2>
        
        Statements: <span class="metric">21.59% <small>(38 / 176)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">21.52% <small>(17 / 79)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">7.32% <small>(6 / 82)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">13.42% <small>(20 / 149)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-github-api/node_modules/github-api/dist/components/</a> &#187; Repository.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    */
<span class="fstat-no" title="function not covered" >   function Repository(fullname, auth, apiBase) {</span>
<span class="cstat-no" title="statement not covered" >      _classCallCheck(this, Repository);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var _this = _possibleConstructorReturn(this, (Repository.__proto__ || Object.getPrototypeOf(Repository)).call(this, auth, apiBase));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      _this.__fullname = fullname;</span>
<span class="cstat-no" title="statement not covered" >      _this.__currentTree = {</span>
         branch: null,
         sha: null
      };
...
&nbsp;
   _createClass(Repository, [{
      key: 'getRef',
      value: <span class="fstat-no" title="function not covered" >function getRef(ref, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/git/refs/' + ref, null, cb);</span>
      }
&nbsp;
      /**
       * Create a reference
...
&nbsp;
      ...
      key: 'createRef',
      value: <span class="fstat-no" title="function not covered" >function createRef(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/git/refs', options, cb);</span>
      }
&nbsp;
      /**
       * Delete a reference
...
&nbsp;
      ...
      key: 'deleteRef',
      value: <span class="fstat-no" title="function not covered" >function deleteRef(ref, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/repos/' + this.__fullname + '/git/refs/' + ref, null, cb);</span>
      }
&nbsp;
      /**
       * Delete a repository
...
&nbsp;
      ...
      key: 'deleteRepo',
      value: <span class="fstat-no" title="function not covered" >function deleteRepo(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/repos/' + this.__fullname, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listTags',
      value: <span class="fstat-no" title="function not covered" >function listTags(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/tags', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function listPullRequests(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         options = options || {};</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/pulls', options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getPullRequest',
      value: <span class="fstat-no" title="function not covered" >function getPullRequest(number, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/pulls/' + number, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function listPullRequestFiles(number, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/pulls/' + number + '/files', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'compareBranches',
      value: <span class="fstat-no" title="function not covered" >function compareBranches(base, head, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/compare/' + base + '...' + head, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listBranches',
      value: <span class="fstat-no" title="function not covered" >function listBranches(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/branches', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getBlob',
      value: <span class="fstat-no" title="function not covered" >function getBlob(sha, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/git/blobs/' + sha, null, cb, 'raw');</span>
      }
&nbsp;
      /**
       * Get a single branch
...
&nbsp;
      ...
      key: 'getBranch',
      value: <span class="fstat-no" title="function not covered" >function getBranch(branch, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/branches/' + branch, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getCommit',
      value: <span class="fstat-no" title="function not covered" >function getCommit(sha, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/git/commits/' + sha, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listCommits',
      value: <span class="fstat-no" title="function not covered" >function listCommits(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         options = options || {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         options.since = this._dateToISO(options.since);</span>
<span class="cstat-no" title="statement not covered" >         options.until = this._dateToISO(options.until);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/commits', options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getSingleCommit',
      value: <span class="fstat-no" title="function not covered" >function getSingleCommit(ref, cb) {</span>
<span class="cstat-no" title="statement not covered" >         ref = ref || '';</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/commits/' + ref, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getSha',
      value: <span class="fstat-no" title="function not covered" >function getSha(branch, path, cb) {</span>
<span class="cstat-no" title="statement not covered" >         branch = branch ? '?ref=' + branch : '';</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/contents/' + path + branch, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listStatuses',
      value: <span class="fstat-no" title="function not covered" >function listStatuses(sha, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/commits/' + sha + '/statuses', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getTree',
      value: <span class="fstat-no" title="function not covered" >function getTree(treeSHA, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/git/trees/' + treeSHA, null, cb);</span>
      }
&nbsp;
      /**
       * Create a blob
...
&nbsp;
      ...
      key: 'createBlob',
      value: <span class="fstat-no" title="function not covered" >function createBlob(content, cb) {</span>
<span class="cstat-no" title="statement not covered" >         var postBody = this._getContentObject(content);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         log('sending content', postBody);</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/git/blobs', postBody, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function _getContentObject(content) {</span>
<span class="cstat-no" title="statement not covered" >         if (typeof content === 'string') {</span>
<span class="cstat-no" title="statement not covered" >            log('contet is a string');</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
               content: _utf2.default.encode(content),
               encoding: 'utf-8'
            };
         } else <span class="cstat-no" title="statement not covered" >if (typeof Buffer !== 'undefined' &amp;&amp; content instanceof Buffer) {</span>
<span class="cstat-no" title="statement not covered" >            log('We appear to be in Node');</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
               content: content.toString('base64'),
               encoding: 'base64'
            };
         } else <span class="cstat-no" title="statement not covered" >if (typeof Blob !== 'undefined' &amp;&amp; content instanceof Blob) {</span>
<span class="cstat-no" title="statement not covered" >            log('We appear to be in the browser');</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
            ...
            // eslint-disable-line
<span class="cstat-no" title="statement not covered" >            log('Not sure what this content is: ' + (typeof content === 'undefined' ? 'undefined' : _typeof(content)) + ', ' + JSON.stringify(content));</span>
<span class="cstat-no" title="statement not covered" >            throw new Error('Unknown content passed to postBlob. Must be string or Buffer (node) or Blob (web)');</span>
         }
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'updateTree',
      value: <span class="fstat-no" title="function not covered" >function updateTree(baseTreeSHA, path, blobSHA, cb) {</span>
<span class="cstat-no" title="statement not covered" >         var newTree = {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/git/trees', newTree, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'createTree',
      value: <span class="fstat-no" title="function not covered" >function createTree(tree, baseSHA, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/git/trees', {</span>
            tree: tree,
...
&nbsp;
      ...
      key: 'commit',
      value: <span class="fstat-no" title="function not covered" >function commit(parent, tree, message, cb) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/git/commits', data, cb).then(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >            _this2.__currentTree.sha = response.data.sha; </span>// Update latest commit
...
&nbsp;
      ...
      key: 'updateHead',
      value: <span class="fstat-no" title="function not covered" >function updateHead(ref, commitSHA, force, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/repos/' + this.__fullname + '/git/refs/' + ref, {</span>
            sha: commitSHA,
            force: force
         }, cb);
      }
...
&nbsp;
      ...
      key: 'updateStatus',
      value: <span class="fstat-no" title="function not covered" >function updateStatus(commitSHA, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/statuses/' + commitSHA, options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function updateRepository(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/repos/' + this.__fullname, options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getDetails',
      value: <span class="fstat-no" title="function not covered" >function getDetails(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getContributors',
      value: <span class="fstat-no" title="function not covered" >function getContributors(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/contributors', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function getContributorStats(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/stats/contributors', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function getCollaborators(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/collaborators', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'isCollaborator',
      value: <span class="fstat-no" title="function not covered" >function isCollaborator(username, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/collaborators/' + username, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getContents',
      value: <span class="fstat-no" title="function not covered" >function getContents(ref, path, raw, cb) {</span>
<span class="cstat-no" title="statement not covered" >         path = path ? '' + encodeURI(path) : '';</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/contents/' + path, {</span>
            ref: ref
         }, cb, raw);
      }
&nbsp;
...
&nbsp;
      ...
      key: 'getReadme',
      value: <span class="fstat-no" title="function not covered" >function getReadme(ref, raw, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/readme', {</span>
            ref: ref
         }, cb, raw);
      }
&nbsp;
...
&nbsp;
      ...
      key: 'fork',
      value: <span class="fstat-no" title="function not covered" >function fork(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/forks', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listForks',
      value: <span class="fstat-no" title="function not covered" >function listForks(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/forks', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'createBranch',
      value: <span class="fstat-no" title="function not covered" >function createBranch(oldBranch, newBranch, cb) {</span>
<span class="cstat-no" title="statement not covered" >         var _this3 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         if (typeof newBranch === 'function') {</span>
<span class="cstat-no" title="statement not covered" >            cb = newBranch;</span>
<span class="cstat-no" title="statement not covered" >            newBranch = oldBranch;</span>
<span class="cstat-no" title="statement not covered" >            oldBranch = 'master';</span>
         }
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this.getRef('heads/' + oldBranch).then(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >            var sha = response.data.object.sha;</span>
<span class="cstat-no" title="statement not covered" >            return _this3.createRef({</span>
               sha: sha,
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function createPullRequest(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/pulls', options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function updatePullRequest(number, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/repos/' + this.__fullname + '/pulls/' + number, options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listHooks',
      value: <span class="fstat-no" title="function not covered" >function listHooks(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/hooks', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getHook',
      value: <span class="fstat-no" title="function not covered" >function getHook(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/hooks/' + id, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'createHook',
      value: <span class="fstat-no" title="function not covered" >function createHook(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/hooks', options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'updateHook',
      value: <span class="fstat-no" title="function not covered" >function updateHook(id, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/repos/' + this.__fullname + '/hooks/' + id, options, cb);</span>
      }
&nbsp;
      /**
       * Delete a webhook
...
&nbsp;
      ...
      key: 'deleteHook',
      value: <span class="fstat-no" title="function not covered" >function deleteHook(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', this.__fullname + '/hooks/' + id, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listKeys',
      value: <span class="fstat-no" title="function not covered" >function listKeys(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/keys', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getKey',
      value: <span class="fstat-no" title="function not covered" >function getKey(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/keys/' + id, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'createKey',
      value: <span class="fstat-no" title="function not covered" >function createKey(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/keys', options, cb);</span>
      }
&nbsp;
      /**
       * Delete a deploy key
...
&nbsp;
      ...
      key: 'deleteKey',
      value: <span class="fstat-no" title="function not covered" >function deleteKey(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/repos/' + this.__fullname + '/keys/' + id, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'deleteFile',
      value: <span class="fstat-no" title="function not covered" >function deleteFile(branch, path, cb) {</span>
<span class="cstat-no" title="statement not covered" >         var _this4 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this.getSha(branch, path).then(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >            var deleteCommit = {</span>
               message: 'Delete the file at \'' + path + '\'',
               sha: response.data.sha,
               branch: branch
            };
<span class="cstat-no" title="statement not covered" >            return _this4._request('DELETE', '/repos/' + _this4.__fullname + '/contents/' + path, deleteCommit, cb);</span>
         });
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'move',
      value: <span class="fstat-no" title="function not covered" >function move(branch, oldPath, newPath, cb) {</span>
<span class="cstat-no" title="statement not covered" >         var _this5 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >         var oldSha = void 0;</span>
<span class="cstat-no" title="statement not covered" >         return this.getRef('heads/' + branch).then(<span class="fstat-no" title="function not covered" >function (_ref) {</span></span>
<span class="cstat-no" title="statement not covered" >            var object = _ref.data.object;</span>
<span class="cstat-no" title="statement not covered" >            return _this5.getTree(object.sha + '?recursive=true');</span>
         }).then(<span class="fstat-no" title="function not covered" >function (_ref2) {</span>
<span class="cstat-no" title="statement not covered" >            var _ref2$data = _ref2.data,</span>
                tree = _ref2$data.tree,
                sha = _ref2$data.sha;
&nbsp;
<span class="cstat-no" title="statement not covered" >            oldSha = sha;</span>
<span class="cstat-no" title="statement not covered" >            var newTree = tree.map(<span class="fstat-no" title="function not covered" >function (ref) {</span></span>
<span class="cstat-no" title="statement not covered" >               if (ref.path === oldPath) {</span>
<span class="cstat-no" title="statement not covered" >                  ref.path = newPath;</span>
               }
<span class="cstat-no" title="statement not covered" >               if (ref.type === 'tree') {</span>
<span class="cstat-no" title="statement not covered" >                  delete ref.sha;</span>
               }
<span class="cstat-no" title="statement not covered" >               return ref;</span>
            });
<span class="cstat-no" title="statement not covered" >            return _this5.createTree(newTree);</span>
         }).then(<span class="fstat-no" title="function not covered" >function (_ref3) {</span>
<span class="cstat-no" title="statement not covered" >            var tree = _ref3.data;</span>
<span class="cstat-no" title="statement not covered" >            return _this5.commit(oldSha, tree.sha, 'Renamed \'' + oldPath + '\' to \'' + newPath + '\'');</span>
         }).then(<span class="fstat-no" title="function not covered" >function (_ref4) {</span>
<span class="cstat-no" title="statement not covered" >            var commit = _ref4.data;</span>
<span class="cstat-no" title="statement not covered" >            return _this5.updateHead('heads/' + branch, commit.sha, true, cb);</span>
         });
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'writeFile',
      value: <span class="fstat-no" title="function not covered" >function writeFile(branch, path, content, message, options, cb) {</span>
...
<span class="cstat-no" title="statement not covered" >         var filePath = path ? encodeURI(path) : '';</span>
<span class="cstat-no" title="statement not covered" >         var shouldEncode = options.encode !== false;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >         return this.getSha(branch, filePath).then(<span class="fstat-no" title="function not covered" >function (response) {</span></span>
<span class="cstat-no" title="statement not covered" >            commit.sha = response.data.sha;</span>
<span class="cstat-no" title="statement not covered" >            return _this6._request('PUT', '/repos/' + _this6.__fullname + '/contents/' + filePath, commit, cb);</span>
...
&nbsp;
      ...
      key: 'isStarred',
      value: <span class="fstat-no" title="function not covered" >function isStarred(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request204or404('/user/starred/' + this.__fullname, null, cb);</span>
      }
&nbsp;
      /**
       * Star a repository
...
&nbsp;
      ...
      key: 'star',
      value: <span class="fstat-no" title="function not covered" >function star(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PUT', '/user/starred/' + this.__fullname, null, cb);</span>
      }
&nbsp;
      /**
       * Unstar a repository
...
&nbsp;
      ...
      key: 'unstar',
      value: <span class="fstat-no" title="function not covered" >function unstar(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/user/starred/' + this.__fullname, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'createRelease',
      value: <span class="fstat-no" title="function not covered" >function createRelease(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/releases', options, cb);</span>
      }
&nbsp;
      /**
       * Edit a release
...
&nbsp;
      ...
      key: 'updateRelease',
      value: <span class="fstat-no" title="function not covered" >function updateRelease(id, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PATCH', '/repos/' + this.__fullname + '/releases/' + id, options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listReleases',
      value: <span class="fstat-no" title="function not covered" >function listReleases(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/releases', null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'getRelease',
      value: <span class="fstat-no" title="function not covered" >function getRelease(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('GET', '/repos/' + this.__fullname + '/releases/' + id, null, cb);</span>
      }
&nbsp;
      /**
       * Delete a release
...
&nbsp;
      ...
      key: 'deleteRelease',
      value: <span class="fstat-no" title="function not covered" >function deleteRelease(id, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('DELETE', '/repos/' + this.__fullname + '/releases/' + id, null, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      value: <span class="fstat-no" title="function not covered" >function mergePullRequest(number, options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._request('PUT', '/repos/' + this.__fullname + '/pulls/' + number + '/merge', options, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'listProjects',
      value: <span class="fstat-no" title="function not covered" >function listProjects(cb) {</span>
<span class="cstat-no" title="statement not covered" >         return this._requestAllPages('/repos/' + this.__fullname + '/projects', { AcceptHeader: 'inertia-preview' }, cb);</span>
      }
&nbsp;
      /**
...
&nbsp;
      ...
      key: 'createProject',
      value: <span class="fstat-no" title="function not covered" >function createProject(options, cb) {</span>
<span class="cstat-no" title="statement not covered" >         options = options || {};</span>
<span class="cstat-no" title="statement not covered" >         options.AcceptHeader = 'inertia-preview';</span>
<span class="cstat-no" title="statement not covered" >         return this._request('POST', '/repos/' + this.__fullname + '/projects', options, cb);</span>
      }
   }]);
&nbsp;
   return Repository;
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Thu Apr 20 2017 14:14:35 GMT+0000 (UTC)</div>
</div>
</body>
</html>
